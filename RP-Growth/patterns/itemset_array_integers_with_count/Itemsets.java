...
public class Itemsets{
	 ...
	 */
	public void printItemsets(int nbObject, ArrayList<String> decode) {
...
//				Arrays.sort(itemset.getItems());
				...
				if(itemset.size() == 1)
				{
					System.out.print(decode.get(itemset.get(0)) + " ---> logged " + itemset.getAbsoluteSupport() + " times.");
				}
				else
				{
					System.out.print(decode.get(itemset.get(0)) + " from IP: " + decode.get(itemset.get(1)) + " ---> logged " + itemset.getAbsoluteSupport() + " times.");
				}
